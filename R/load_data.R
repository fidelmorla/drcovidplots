...
#' @description This function loads information contained in googlessheets about
...
load_data_covid_dr <- function(){
  ...
  url_data_covid_dr <- paste0('https://docs.google.com/spreadsheets/',
                              'd/1ggYhkvTmgiaINAw-v9W5j7M9nMQDgz6HWYPBMbonQ5A/',
                              'edit#gid=1991137940')

  list_data <- list(

  data_cum =
    read_sheet(url_data_covid_dr,
               sheet = "nc")  %>%
